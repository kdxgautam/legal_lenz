...
VECTOR_ORIGINAL_K = _int("VECTOR_ORIGINAL_K", 5)
VECTOR_REWRITE_K = _int("VECTOR_REWRITE_K", 5)
FTS_K = _int("FTS_K", 5)
FUSION_K = _int("FUSION_K", 10)
RERANK_CANDIDATES = _int("RERANK_CANDIDATES", 5)
FINAL_CONTEXT_K = _int("FINAL_CONTEXT_K", 5)
